...
class PostService {
	...
	createPost = async (nickname, userId, title, content) => {
		await this.postRepository.create(nickname, userId, title, content);
	};
	...
	findPostById = async (postId) => {
		const post = await this.postRepository.findOneByPostId(postId);
	...
	findPost = async (userId, postId) => {
		const post = await this.postRepository.findOneByIds(userId, postId);
	...
	updatePost = async (title, content, postId, userId) => {
		...
		await this.postRepository.update(title, content, postId, userId).catch((error) => {
	...
	deletePost = async (postId, userId) => {
		...
		await this.postRepository.remove(postId, userId).catch((error) => {
